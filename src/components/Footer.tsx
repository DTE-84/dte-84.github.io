...
const Footer: React.FC<FooterProps> = ({ onContactClick }) => {
  return (
    <footer id="footer" className="relative border-t border-accent/10 bg-black/40 backdrop-blur-md overflow-hidden mt-80">
      <div className="container-main pt-[200px] pb-24 relative z-10">
          ...
          <div className="flex flex-col justify-between">
            <div className="space-y-12">
              ...
              <p className="text-zinc-400 text-lg max-w-md leading-relaxed">
                Have a project in mind or just want to discuss high-fidelity frontend architecture? My uplink is always active.
              </p>
            </div>

            <div className="flex flex-col gap-4 pt-12">
              <a href="mailto:drew.t.ernst@gmail.com" className="flex items-center gap-4 text-white group hover:text-accent transition-colors">
                ...
                <span className="font-mono text-xs uppercase tracking-widest">drew.t.ernst@gmail.com</span>
              </a>
              <a href="/assets/DTEresume.pdf" target="_blank" className="flex items-center gap-4 text-white group hover:text-accent transition-colors">
                <div className="w-10 h-10 rounded-none border border-accent/40 flex items-center justify-center group-hover:border-accent/50 transition-all">
                  <Icon icon="solar:document-linear" className="text-xl" />
                </div>
                <span className="font-mono text-xs uppercase tracking-widest">Download Resume // PDF</span>
              </a>
              <div className="flex items-center gap-4 text-white">
                ...
                <span className="font-mono text-xs uppercase tracking-widest">Available Remotely // CST</span>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="form__item">
                    <label className="block text-[9px] font-bold uppercase mb-2 text-accent tracking-[0.2em]">Full Name</label>
                    <input className="w-full p-4 bg-white/5 border border-accent/40 rounded-none text-white font-bold outline-none font-mono text-xs uppercase placeholder:text-white/20 focus:border-accent/50 transition-all" placeholder="NAME" name="user_name" type="text" required />
                  </div>
                  <div className="form__item">
                    <label className="block text-[9px] font-bold uppercase mb-2 text-accent tracking-[0.2em]">Email Address</label>
                    <input className="w-full p-4 bg-white/5 border border-accent/40 rounded-none text-white font-bold outline-none font-mono text-xs uppercase placeholder:text-white/20 focus:border-accent/50 transition-all" placeholder="EMAIL" name="user_email" type="email" required />
                  </div>
                </div>
                <div className="form__item">
                  <label className="block text-[9px] font-bold uppercase mb-2 text-accent tracking-[0.2em]">Message</label>
                  <textarea className="w-full p-4 bg-white/5 border border-accent/40 rounded-none text-white font-bold outline-none h-24 font-mono text-xs uppercase placeholder:text-white/20 focus:border-accent/50 transition-all resize-none" placeholder="MESSAGE..." name="message" required></textarea>
                </div>
              </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-12 border-t border-accent/20 gap-8">
          <div className="flex items-center gap-4">
            ...
            <p className="font-mono text-[9px] uppercase tracking-[0.3em] opacity-40">Portfolio 2025</p>
          </div>
