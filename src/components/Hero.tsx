  ...
  return (
    <section id="home" className="hero min-h-screen flex items-center justify-center text-center pt-[100px] bg-transparent">
      <div className="container-main hero-content">
        <h1 className="text-white font-bold uppercase leading-none mb-4 text-[clamp(2.2rem,10vw,6rem)] tracking-[clamp(4px,2vw,8px)] relative inline-block z-10 w-full glitch-title">
