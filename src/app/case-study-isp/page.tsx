          ...
          <div className="grid lg:grid-cols-2 gap-12 items-end">
            <div className="lg:order-2 text-right">
              <h1 className="text-5xl md:text-7xl font-orbitron uppercase leading-none mb-8 glow-text tracking-normal text-white">
                PCSP Assistant <br /><span className="text-[#00ffcc] italic">Pro</span>
              </h1>
        ...
        <div className="space-y-32">
          ...
          <section id="challenge" className="grid lg:grid-cols-3 gap-12 pt-[100px]">
            ...
            <div className="lg:col-span-2 space-y-8">
              <p className="text-lg text-white/95 font-medium leading-relaxed">
                The Marion County Services for the Department of Developmental Disabilities was struggling with an outdated, narrative-heavy Person Centered Service Plan (PCSP) process that placed immense burden on frontline staff.
              </p>
              <div className="grid gap-6">
                <div className="p-6 rounded-xl border border-[#00ffcc]/20 bg-white/5 backdrop-blur-sm">
                  ...
                  <p className="text-base text-white/85">
                    Case Managers (CMs) spent 40% of their week on manual data entry, leading to extreme &quot;click-fatigue&quot; and organizational burnout. Each plan required documenting demographics, communication profiles, personal preferences, relationships, health risk, and measurable outcomes — all by hand, across multiple disconnected systems.
                  </p>
                </div>
                <div className="p-6 rounded-xl border border-[#00ffcc]/20 bg-white/5 backdrop-blur-sm">
                  <h4 className="text-[#00ffcc] text-[14px] font-black uppercase tracking-widest mb-3 font-orbitron">The Compliance Gap</h4>
                  <p className="text-base text-white/85">
                    State auditors require rigorous &quot;Active Treatment&quot; language, structured communication profiles, and documented person-centered supports. Vague phrasing, missing communication barriers, or undocumented important relationships led to rejected plans, delayed services, and high audit risk.
                  </p>
                </div>
                <div className="p-6 rounded-xl border border-[#00ffcc]/20 bg-white/5 backdrop-blur-sm border-red-500/20">
                  ...
                  <p className="text-base text-white/85">
                    Standard cloud tools (Notion, Google Docs) were prohibited due to lack of BAAs and strict patient confidentiality laws. Any solution had to process sensitive PHI without transmitting it to any external server.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section id="solution" className="grid lg:grid-cols-3 gap-12 pt-[100px]">
            ...
            <div className="lg:col-span-2 space-y-12">
              <p className="text-lg text-white/95 font-medium leading-relaxed">
                I engineered a Zero-Footprint Logic Engine — a client-side web application that acts as a clinical &quot;narrative calculator.&quot; This tool bridges the gap between raw client information and Missouri-mandated PCSP clinical markers, covering every required domain from demographics to measurable outcomes in a single unified workspace.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-white/85 leading-loose">
                    Uses a dropdown-driven &quot;Building Block&quot; approach to turn casual goals into standardized SMART goals instantly. Each of the nine PCSP sections is self-contained and collapses cleanly for focused drafting.
                  </p>
                </div>
                <div className="space-y-4">
                  <h4 className="text-white font-bold uppercase tracking-widest text-sm flex items-center gap-3 font-orbitron">
                ...
                <div className="space-y-4">
                  <h4 className="text-white font-bold uppercase tracking-widest text-sm flex items-center gap-3 font-orbitron">
                    <Icon icon="solar:chat-square-like-linear" className="text-[#00ffcc]" /> Communication Profiling
                  </h4>
                  <p className="text-sm text-white/85 leading-loose">
                    A full communication section captures primary language, sign language type, method checkboxes, evaluation status, identified barriers, and a dynamic chart mapping behaviors to staff responses — all per Missouri DD guidelines.
                  </p>
                </div>
                <div className="space-y-4">
                  <h4 className="text-white font-bold uppercase tracking-widest text-sm flex items-center gap-3 font-orbitron">
                    <Icon icon="solar:users-group-rounded-linear" className="text-[#00ffcc]" /> Person-Centered Supports
                  </h4>
                  <p className="text-sm text-white/85 leading-loose">
                    Dedicated sections capture what the individual likes and dislikes, plus an unlimited dynamic roster of important people — each with their relationship, shared activities, and frequency of contact.
                  </p>
                </div>
                <div className="space-y-4">
                  <h4 className="text-white font-bold uppercase tracking-widest text-sm flex items-center gap-3 font-orbitron">
                    <Icon icon="solar:diskette-linear" className="text-[#00ffcc]" /> Portable File System
                  </h4>
                  <p className="text-sm text-white/85 leading-loose">
                    Plans are saved as encrypted <span className="text-[#00ffcc] font-mono">.pcsp</span> files locally, opened and auto-filled on demand, printed as clean PDFs, or kept as browser drafts — zero cloud dependency.
                  </p>
                </div>
                <div className="space-y-4">
                  <h4 className="text-white font-bold uppercase tracking-widest text-sm flex items-center gap-3 font-orbitron">
                    <Icon icon="solar:shield-keyhole-linear" className="text-[#00ffcc]" /> HIPAA Privacy Mode
                  </h4>
                  <p className="text-sm text-white/85 leading-loose">
                    A toggle instantly masks all PHI in the live preview with anonymized placeholders, allowing safe screen-sharing during team meetings without ever exposing client data.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section id="execution" className="grid lg:grid-cols-3 gap-12 pt-[100px]">
            ...
            <div className="lg:col-span-2 space-y-12">
                ...
                <div className="flex gap-6 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/95">
                      Deep-dive analysis of Missouri 9 CSR 45-3.010 and the &quot;Good Life&quot; Framework to identify required clinical triggers. This included mapping the full PCSP domain structure — demographics, communication profiling, person-centered preferences, vision, health and risk, legal rights, and measurable outcomes.
                    </p>
                  </div>
                </div>
                <div className="flex gap-6 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/95">
                      Opted for a single-file HTML/JS deployment. By processing data only in the browser&apos;s volatile RAM, I bypassed the need for IT server infrastructure while maintaining 100% HIPAA compliance. No POST requests. No databases. No third-party dependencies.
                    </p>
                  </div>
                </div>
                <div className="flex gap-6 items-start">
                  <div className="text-[#00ffcc] font-black font-space text-3xl opacity-20 italic">03</div>
                  <div>
                    <h4 className="text-white font-bold uppercase tracking-widest text-base mb-2 font-orbitron">Communication Module</h4>
                    <p className="text-sm text-white/95">
                      Built a structured communication profiling system covering primary language, sign language type selection, a multi-select method checklist (Verbal, AAC Device, PECS, Gestures, Eye Gaze, and more), evaluation status with conditional barrier documentation, and a fully dynamic Communication Chart. Each chart row maps a specific situation or behavior to its meaning and the correct staff response — a direct Missouri DD compliance requirement.
                    </p>
                  </div>
                </div>
                <div className="flex gap-6 items-start">
                  <div className="text-[#00ffcc] font-black font-space text-3xl opacity-20 italic">04</div>
                  <div>
                    <h4 className="text-white font-bold uppercase tracking-widest text-base mb-2 font-orbitron">Likes, Dislikes &amp; Person-Centered Supports</h4>
                    <p className="text-sm text-white/95">
                      Designed dedicated form sections for capturing what the individual genuinely enjoys — favorite activities, foods, and places — alongside dislikes, triggers, and sensory sensitivities. This feeds directly into the narrative and ensures plans reflect the individual&apos;s actual life, not just clinical boilerplate.
                    </p>
                  </div>
                </div>
                <div className="flex gap-6 items-start">
                  <div className="text-[#00ffcc] font-black font-space text-3xl opacity-20 italic">05</div>
                  <div>
                    <h4 className="text-white font-bold uppercase tracking-widest text-base mb-2 font-orbitron">Important People Engine</h4>
                    <p className="text-sm text-white/95">
                      Engineered a dynamic multi-entry system for documenting the people who matter most to the individual. Each entry captures name, relationship, and an unlimited list of shared activities with frequency of contact. Staff can add or remove people and activities on the fly — the narrative auto-updates in real time. This satisfies the &quot;Natural Supports&quot; documentation requirement without requiring a separate system.
                    </p>
                  </div>
                </div>
                <div className="flex gap-6 items-start">
                  <div className="text-[#00ffcc] font-black font-space text-3xl opacity-20 italic">06</div>
                  <div>
                    <h4 className="text-white font-bold uppercase tracking-widest text-base mb-2 font-orbitron">Portable File System (.pcsp)</h4>
                    <p className="text-sm text-white/95">
                      Implemented a complete save/restore pipeline using a custom <span className="text-[#00ffcc] font-mono">.pcsp</span> file format. On export, the full plan state — including all dynamic entries like legal reps, communication chart rows, important people, checkboxes, and narrative — is serialized to a locally stored JSON file. On import, a single file upload auto-fills the entire form in seconds. Plans can also be printed to PDF via a dedicated print stylesheet that strips all UI chrome and renders only the clean PCSP document.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-xl border border-[#00ffcc]/20 bg-white/5">
                <h4 className="text-[#00ffcc] text-[13px] font-black uppercase tracking-widest mb-6 font-orbitron">Full Section Architecture — 9 PCSP Domains</h4>
                <div className="grid md:grid-cols-3 gap-3">
                  {[
                    ...
                    <div key={item.num} className="flex items-center gap-3 p-3 rounded-lg bg-black/30 border border-white/5">
                      <span className="text-[#00ffcc]/30 font-mono text-[11px] font-black">{item.num}</span>
                      <span className="text-white/80 text-[12px] font-bold uppercase tracking-wide">{item.label}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left border-separate border-spacing-y-2">
                  ...
                  <tbody className="text-sm">
                    ...
                    <tr className="bg-white/[0.02]">
                      <td className="p-4 border-t border-b border-l border-white/5 rounded-l-lg font-bold text-white">Communication Docs</td>
                      <td className="p-4 border-t border-b border-white/5 text-white/85 italic">Inconsistent / Missing</td>
                      <td className="p-4 border-t border-b border-r border-white/5 rounded-r-lg text-[#00ffcc] font-black uppercase tracking-widest">Structured + Charted</td>
                    </tr>
                    <tr className="bg-white/[0.02]">
                      <td className="p-4 border-t border-b border-l border-white/5 rounded-l-lg font-bold text-white">Plan Portability</td>
                      <td className="p-4 border-t border-b border-white/5 text-white/85 italic">Locked to One Machine</td>
                      <td className="p-4 border-t border-b border-r border-white/5 rounded-r-lg text-[#00ffcc] font-black uppercase tracking-widest">.pcsp File / PDF</td>
                    </tr>
                    <tr className="bg-white/[0.02]">
                      <td className="p-4 border-t border-b border-l border-white/5 rounded-l-lg font-bold text-white">Person-Centered Data</td>
                      <td className="p-4 border-t border-b border-white/5 text-white/85 italic">Freeform / Overlooked</td>
                      <td className="p-4 border-t border-b border-r border-white/5 rounded-r-lg text-[#00ffcc] font-black uppercase tracking-widest">Structured Profiles</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <section id="appendix" className="grid lg:grid-cols-3 gap-12 pt-[100px]">
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div className="space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 rounded-lg bg-white/5 border border-[#00ffcc]/20">
                    ...
                    <p className="text-[14px] text-white/85">All logic executes in the browser RAM. Data never leaves Volatile Memory during a live session.</p>
                  </div>
                  <div className="p-4 rounded-lg bg-white/5 border border-[#00ffcc]/20">
                  ...
                  <div className="p-4 rounded-lg bg-white/5 border border-[#00ffcc]/20">
                    <span className="text-[#00ffcc] text-[14px] font-black uppercase block mb-2 font-orbitron">.pcsp Export</span>
                    <p className="text-[14px] text-white/85">When persistence is needed, the full plan state serializes to a local <span className="font-mono">.pcsp</span> file. The CM controls where it lives — agency drive, encrypted USB, or secure folder.</p>
                  </div>
                  <div className="p-4 rounded-lg bg-white/5 border border-[#00ffcc]/20">
                    <span className="text-[#00ffcc] text-[14px] font-black uppercase block mb-2 font-orbitron">Browser Drafts</span>
                    <p className="text-[14px] text-white/85">Up to 10 in-progress drafts are stored in localStorage on the local machine only — never synced, never transmitted.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <h3 className="text-white font-bold uppercase tracking-widest text-base border-b border-[#00ffcc]/40 pb-2 font-orbitron">III. Dynamic Data Architecture</h3>
                <p className="text-sm text-white/95">
                  Several sections of the PCSP require an unbounded number of entries — legal representatives, communication chart rows, and important people with their activities. These are managed via in-memory JavaScript arrays rendered to the DOM on each state change, with full capture and restore on <span className="font-mono text-[#00ffcc]">.pcsp</span> export and import.
                </p>
                <div className="p-6 rounded-xl bg-black border border-[#00ffcc]/40 font-mono text-sm space-y-1">
                  <div><span className="text-purple-400">legalReps</span><span className="text-zinc-400"> = []  </span><span className="text-zinc-500">// guardians, POA, custodians</span></div>
                  <div><span className="text-purple-400">commChartRows</span><span className="text-zinc-400"> = []  </span><span className="text-zinc-500">// behavior → meaning → response</span></div>
                  <div><span className="text-purple-400">importantPeople</span><span className="text-zinc-400"> = []  </span><span className="text-zinc-500">// person → relationship → activities[]</span></div>
                  <div className="pt-2 text-zinc-500">// all arrays serialize into .pcsp on export</div>
                  <div className="text-zinc-500">// and restore with full fidelity on import</div>
                </div>
              </div>

              <div className="space-y-6">
                <h3 className="text-white font-bold uppercase tracking-widest text-base border-b border-[#00ffcc]/40 pb-2 font-orbitron">IV. Output Pipeline</h3>
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="p-4 rounded-lg bg-white/5 border border-[#00ffcc]/20 text-center">
                    <Icon icon="solar:printer-linear" className="text-[#00ffcc] text-2xl mx-auto mb-2" />
                    <span className="text-[#00ffcc] text-[13px] font-black uppercase block mb-2 font-orbitron">Print / PDF</span>
                    <p className="text-[12px] text-white/75">Dedicated print stylesheet strips all UI chrome. Outputs a clean, PCSP-formatted document ready for signature or filing.</p>
                  </div>
                  <div className="p-4 rounded-lg bg-white/5 border border-[#00ffcc]/20 text-center">
                    <Icon icon="solar:diskette-linear" className="text-[#00ffcc] text-2xl mx-auto mb-2" />
                    <span className="text-[#00ffcc] text-[13px] font-black uppercase block mb-2 font-orbitron">.pcsp File</span>
                    <p className="text-[12px] text-white/75">Full plan state exported as a portable JSON-based file. Auto-fills every field — including dynamic entries — on re-import.</p>
                  </div>
                  <div className="p-4 rounded-lg bg-white/5 border border-[#00ffcc]/20 text-center">
                    <Icon icon="solar:copy-linear" className="text-[#00ffcc] text-2xl mx-auto mb-2" />
                    <span className="text-[#00ffcc] text-[13px] font-black uppercase block mb-2 font-orbitron">Clipboard</span>
                    <p className="text-[12px] text-white/75">One-click copy of the full narrative summary to paste directly into CIMOR, MOEDIWEB, or any agency system.</p>
                  </div>
                </div>
              </div>

              <div className="space-y-6">
                <h3 className="text-white font-bold uppercase tracking-widest text-base border-b border-[#00ffcc]/40 pb-2 font-orbitron">V. Deployment Strategy</h3>
                <p className="text-base text-white/95">
                  Hosted on the agency&apos;s <span className="text-white font-bold">internal drive</span>. It inherits existing Windows Active Directory permissions, removing the need for a separate login system. Staff open the file in any modern browser — no installation, no IT ticket, no licensing cost.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="pb-32">
            <div className="circuit-border p-12 bg-[#00ffcc]/5 rounded-2xl text-center border border-[#00ffcc]/20">
              ...
              <p className="text-xl font-space text-white/80 max-w-3xl mx-auto leading-relaxed mb-12">
                &quot;By leveraging a client-side JavaScript architecture, I provided the Marion County Department of Mental Health with a modern, high-speed drafting tool that satisfies the &apos;Security Rule&apos; of HIPAA. The tool covers all nine Missouri PCSP domains — including structured communication profiling, person-centered likes and dislikes, and a dynamic important people roster — without a single line of data ever leaving the user&apos;s machine. This project demonstrates my ability to build high-impact clinical tools within highly regulated environments where traditional cloud solutions are often prohibited.&quot;
              </p>
